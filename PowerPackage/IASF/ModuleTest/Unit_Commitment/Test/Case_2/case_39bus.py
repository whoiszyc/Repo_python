...
def case39():
    ...
    """
    (ZYC@09-30-2018) Generator maximum outout is modified
    """
    ## generator data 
    ...
    ppc["gencost"] = array([
        [2, 20, 10, 2, 33, 0.3, 0.2],
        [2, 20, 10, 2, 25, 0.3, 0.2],
        [2, 20, 20, 2, 37, 0.3, 0.2],
        [2, 20, 20, 2, 49, 0.3, 0.2],
        [2, 20, 30, 2, 55, 0.3, 0.2],
        [2, 40, 20, 2, 34, 0.3, 0.2],
        [2, 10, 10, 2, 65, 0.3, 0.2],
        [2, 30, 20, 2, 35, 0.3, 0.2],
        [2, 20, 10, 2, 28, 0.3, 0.2],
        [2, 10, 20, 2, 56, 0.3, 0.2]
    ])
