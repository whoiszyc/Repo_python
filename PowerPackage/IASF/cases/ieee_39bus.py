...
def case39():
    ...
    # bus_i     type    Pd          Qd      Gs  Bs  area    Vm          Va      baseKV   zone   Vmax   Vmin
        ...
        [17,    1,      0,          0,      0,  0,  3,  1.0342365,  -11.116436,     345,    1,  1.06,   0.94],
        ...
        [27,    1,      281,        75.5,   0,  0,  3,  1.0383449,  -11.362152,     345,    1,  1.06,   0.94],
        [28,    1,      206,        27.6,   0,  0,  2,  1.0503737,  -5.9283592,     345,    1,  1.06,   0.94],
        [29,    1,      283.5,      26.9,   0,  0,  2,  1.0501149,  -3.1698741,     345,    1,  1.06,   0.94],
    ...
    """
    ppc["gen"] = array([
    # index  Pmin   Pmax    Rmax    RU      RD  cost_reserve  cost_startup  minup mindown  base  interia
    [30,    500,    1540,   1000,   300,    400,    5,          1000,       1,      1,      1000,   6],
    [31,    500,    1700,   1000,   300,    400,    5,          1000,       5,      1,      1000,   8],
    [32,    500,    1750,   1000,   300,    400,    5,          1000,       1,      1,      1000,   7],
    [33,    500,    1900,   1000,   300,    400,    5,          1000,       1,      1,      1000,   6],
    [34,    500,    1850,   1000,   300,    400,    5,          1000,       1,      1,      1000,   7],
    [35,    500,    1950,   1000,   300,    400,    5,          1000,       1,      1,      1000,   8],
    [36,    500,    1880,   1000,   300,    400,    5,          1000,       1,      1,      1000,   8],
    [37,    500,    1800,   1000,   300,    400,    5,          1000,       1,      1,      1000,   8],
    [38,    500,    2100,   1000,   300,    400,    5,          1000,       1,      1,      1000,   6],
    [39,    500,    2300,   1000,   300,    400,    5,          1000,       1,      1,      1000,   8],
    ])
